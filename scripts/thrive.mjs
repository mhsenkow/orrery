...
/* -------------------------------------------------------------- census -- */
{c:'census',t:'Birth, so a population can grow',g:'birth',n:['energy'],d:'Landed (first cut). `tryBirth` spends parent energy, writes `parentId`, inherits group. `topUpEntities` still backfills crashes.',k:'MODEL',e:'M',i:3},
...
const P2 = [
/* ---------------------------------------------------------------- hunt -- */
{c:'hunt',t:'A hunt that happens on a cell',g:'hunt',n:['entsim','percept'],d:'Partial. Predators (trophic > 0.55) pick `hunt` and kill a neighbour; energy transfers. No chase path yet.',k:'MODEL',e:'L',i:3},
...
{c:'swarm',t:'A group as an object',g:'group',n:['flock'],d:'Landed (first cut). `writeHerd` mints a named group; members carry `groupId`; `W.groups` is censused each tick; overlay Behaviour paints activity; chronicle can name a pod/herd. Split/merge not yet.',k:'MODEL',e:'M',i:3},
