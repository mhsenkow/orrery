...
const P2 = [
/* ---------------------------------------------------------------- hunt -- */
{c:'hunt',t:'A hunt that happens on a cell',g:'hunt',n:['entsim','percept'],d:'Partial. Predators acquire a `preyId`, close the distance, then kill adjacent. Failure costs energy. No long-range path yet.',k:'MODEL',e:'L',i:3},
...
{c:'swarm',t:'A group as an object',g:'group',n:['flock'],d:'Landed (first cut). Named groups with `home` and `goal`; members bias toward the goal; barren cells send the herd home. Split/merge still open.',k:'MODEL',e:'M',i:3},
