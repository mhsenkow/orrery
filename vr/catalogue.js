...
export const CATALOGUE_CATS = [
  {
    "id": "star",
    "name": "Stellar hosts and the light they cast",
    "blurb": "Today the sun is a normalised direction vector and the sky is three constants per ruleset. Every world below orbits something with a temperature, a size, a temper and sometimes a corpse. This is the first bottleneck: until the star is an object, none of the catalogue can be honest."
  },
  {
    "id": "spin",
    "name": "Orbit, spin, and the shape of a world",
    "blurb": "The prototype spins every planet once a day on a perfect sphere. Real bodies are locked, resonant, tumbling, flattened, torn into eggs, or wearing rings. This category is where \"match them in form and shape\" is actually paid for."
  },
  {
    "id": "matter",
    "name": "Material regimes and new chemistries",
    "blurb": "Six gases and one liquid gets you Earth, Mars and a moon. It does not get you a magma ocean, a hydrogen envelope, a nitrogen glacier or rain made of iron. Each item here unlocks a whole shelf of the catalogue."
  },
  {
    "id": "sol",
  ...
  {
    "id": "instr",
    "name": "Instruments and legibility",
    "blurb": "Bound by the \"every number is a place\" pillar. A catalogue of 150 worlds is a spreadsheet unless the player can see, in the world, why each one turned out the way it did."
  },
  {
    "id": "pipe",
    "name": "Catalogue pipeline and provenance",
    "blurb": "One hundred and fifty hand-written ruleset literals is a maintenance disaster and a citation problem. The catalogue should be data, imported, dated, and honest about what is unknown."
  },
  {
    "id": "play",
    "name": "Play, scenarios and VR",
    "blurb": "Ninety worlds is a menu, not a game. These are the items that turn the catalogue into something a person spends an evening inside."
  }
];
export const CATALOGUE = [
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Make the star an object, not a vector",
    "d": "Give every ruleset a host with effective temperature, radius, mass and age, and derive everything downstream from those four numbers instead of the per-ruleset `solar` constant. TRAPPIST-1 is 2,566 K and 0.12 R☉; KELT-9 is roughly 10,000 K. Nothing else in this document works until this exists.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "spectrum",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Insolation from a real orbit",
    "d": "Replace the hand-tuned `solar` scalar with S = L★/a², expressed in Earth units, so the catalogue can be imported straight from the archive column `pl_insol`. The range we need to span is S = 0.1 (TRAPPIST-1 h) to S = 636,000 (KOI-55 b) — seven orders of magnitude, which the current 0.7–1.2 slider cannot represent.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "lum",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "The star at its true angular size",
    "d": "From the surface of TRAPPIST-1 e the star is about 2° across — four Suns wide — and a dull ember red. From WD 1856+534 b the star is a white pinprick smaller than Venus looks from Earth. Angular size is one line of trigonometry and it is the single most convincing thing a player can be shown.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "angsize",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Sky and surface colour from the stellar spectrum",
    "d": "Rayleigh scattering against a 2,600 K blackbody does not make a blue sky. Compute sky colour from the host spectrum convolved with the actual atmospheric composition, so an M-dwarf world reads as dim, orange and low-contrast without anyone hand-authoring `sky: [r,g,b]`.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "skycolor",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Red light and the limits of photosynthesis",
    "d": "Oxygenic photosynthesis on Earth runs out of usable photons past about 750 nm. An M8 dwarf emits most of its light beyond that, which is why life around TRAPPIST-1 is a genuinely open question. Gate the biosphere on photon flux in a usable band, not on a temperature window.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "redlight",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Flares as discrete, dated events",
    "d": "Proxima Centauri emitted a flare in 2019 that brightened it 14,000-fold in the ultraviolet for seven seconds. Model flares as Poisson events scaled by stellar age and rotation, stripping ozone, spiking surface UV, and writing a line in the chronicle each time.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "flare",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Integrated XUV erosion over the age of the system",
    "d": "M dwarfs stay in a saturated high-energy phase for the first few hundred million years — long enough to strip an Earth atmosphere several times over. Integrate cumulative XUV dose against the escape parameter so \"does this world have air\" is an outcome, not a ruleset flag.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "xuv",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Stellar evolution across the run",
    "d": "The Sun was about 70% as bright 4 Gyr ago and the faint-young-Sun paradox is the reason Daisyworld is in this codebase at all. Let luminosity track main-sequence brightening over deep time so ancient worlds start cold and end hot.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "evolve",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "The red giant phase and engulfment",
    "d": "Run the clock far enough and the host leaves the main sequence: the habitable zone sweeps outward past Mars-analogues and the inner planets are swallowed. It is the natural end-state for a god-game about deep time and it costs one luminosity curve.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "postms",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Binary and hierarchical hosts",
    "d": "Two stars means two insolation terms, two shadows, and a habitable zone that is an annulus rather than a band. GJ 667 C is the third star of a triple; HD 131399 Ab has three suns and a sky that never fully darkens for part of its year.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "binary",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "The circumbinary insolation beat",
    "d": "On Kepler-16 b the two stars orbit each other every 41 days inside the planet's 229-day year, so the received flux beats rather than varies smoothly, and the double shadow crosses the ground on its own cycle. This is the visual payoff of the whole binary item.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "beat",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Starspots, and the lie they tell the spectrograph",
    "d": "Half the \"atmosphere detected\" headlines in the catalogue are contested because an unspotted stellar surface is hard to assume. Model spot coverage, let it contaminate the transit spectrum instrument, and make the player earn the distinction. Nothing else teaches exoplanet science this efficiently.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "spots",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Ultracool dwarf hosts",
    "d": "TRAPPIST-1 (M8 V, 2,566 K), LP 890-9 (M6 V) and SPECULOOS-3 (M6.5 V) are barely stars. Their habitable zones sit at 0.01–0.06 AU, which forces tidal locking, extreme flare exposure and orbital periods measured in days — three regimes at once from one host class.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "ucd",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Brown dwarf hosts: infrared-only light",
    "d": "2M1207 b orbits a 25-Jupiter-mass brown dwarf. The primary is cooler than a campfire and emits almost nothing in the visible. A world lit only in the infrared needs a different albedo model, a different sky, and a biosphere that cannot use light at all.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "bd",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "White dwarf hosts",
    "d": "WD 1856+534 b orbits a stellar corpse the size of Earth every 34 hours, receiving S ≈ 0.18 with an equilibrium temperature of 163 K. The host is small, blue-white, fading on a cooling track, and the habitable zone is so tight that tidal locking is guaranteed.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "wd",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Pulsar hosts: particles, not photons",
    "d": "The PSR B1257+12 planets are heated by relativistic particle wind and X-rays, not by starlight. Albedo is meaningless, the \"day side\" is defined by the beam, and the surface chemistry is radiation-driven. It needs its own energy-budget path through the atmosphere tick.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "pulsar",
  ...
  },
  {
    ...
    "c": "star",
    "k": "PHYS",
    "t": "Stripped-core and subdwarf hosts",
    "d": "KOI-55 b and c orbit a subdwarf B star — a red giant core stripped of its envelope — at 0.24 and 0.34 days, with equilibrium temperatures near 7,800 K and 6,900 K. They are probably the surviving cores of planets that were inside the giant. A whole story told by two rows in a table.",
    "e": "S",
    "i": 2,
    "b": "",
    "s": "sdb",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "No star at all",
    "d": "For free-floating planets the entire external energy term is zero, and the surface budget is radiogenic heat plus whatever the atmosphere retains. This is the cleanest possible test that the climate model is a physics model: set insolation to zero and see whether it still does something interesting.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "nostar",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "1:1 tidal locking with a fixed substellar point",
    "d": "`insolation()` currently blends an instantaneous sun-dot with an orbit-average so nothing freezes in shadow. A locked world needs the opposite: a permanent substellar point, a permanent antistellar point, and no diurnal cycle anywhere. This is the single highest-value item in the document, because most of the catalogue is locked.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "lock",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Eyeball climatology",
    "d": "A locked ocean world develops a substellar hot spot, a habitable terminator ring, and a nightside ice cap that never melts — the \"eyeball planet\". Getting the ring to emerge from the existing hydro and ice code, rather than being painted, is the proof the coupling works.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "eyeball",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Nightside atmospheric collapse",
    "d": "Below a threshold surface pressure, heat transport fails and the atmosphere condenses out permanently on the night side. Above it, circulation keeps the planet aired. Model the threshold and you get the actual scientific question about every locked world in the catalogue as a playable dial.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "collapse",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Equatorial superrotation and the hotspot offset",
    "d": "Hot Jupiters show their hottest point offset east of the substellar point because a broad equatorial jet drags heat downwind — measured on HD 189733 b and dozens since. Add a jet term to `computeWinds` for locked bodies and the offset falls out for free.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "jet",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Spin-orbit resonances other than 1:1",
    "d": "Mercury is in a 3:2 resonance: three rotations per two orbits, so a solar day lasts two Mercury years. Eccentric worlds prefer higher-order resonances to synchronous rotation, and it changes the whole thermal picture. Generalise the locking code to p:q rather than hard-coding synchronous.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "res",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Libration and the twilight band",
    "d": "A locked body with any eccentricity rocks back and forth, so the terminator sweeps a band rather than sitting on a line, and a strip of ground sees the star rise and set without a rotation. On the Moon this exposes an extra 9% of the surface. Small code, large flavour.",
    "e": "S",
    "i": 2,
    "b": "",
    "s": "libration",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Eccentric orbits and flash heating",
    "d": "HD 80606 b has e = 0.932: over six hours near periastron its upper atmosphere climbs from roughly 800 K to 1,500 K, and the whole planet is a seasonal catastrophe. `eccentricity` is already a ruleset field but only modulates insolation by a few percent — let it drive the orbit properly.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "ecc",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Tidal heating as an internal energy source",
    "d": "Io dissipates more heat per unit area than anywhere else in the Solar System, entirely because Europa and Ganymede keep its orbit eccentric. Add a tidal dissipation term driven by eccentricity, orbital distance and rigidity, and feed it into the existing volcanism budget rather than a new system.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "tidalheat",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Obliquity as a genuinely free parameter",
    "d": "The engine supports obliquity but only ever sees 0–25°. Uranus is at 98°, meaning each pole gets 42 years of continuous daylight then 42 of night; Venus is effectively at 177°. Test the seasonal code across the full range — it will break, and fixing it is worth more than any single world.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "obliq",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Retrograde and near-stopped rotation",
    "d": "Venus turns backwards once every 243 days, slower than its 225-day year, so the Sun rises in the west twice per Venusian year. Allow negative and very long rotation periods without the Coriolis term (`1 / max(0.15, rotationPeriod)`) degenerating.",
    "e": "S",
    "i": 2,
    "b": "",
    "s": "retro",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Body shape as a function, not an assumption",
    "d": "The renderer builds a unit sphere and the sim indexes a cube-sphere. Introduce a single `radiusAt(direction)` hook that both consume, defaulting to 1.0. Every remaining shape item in this category becomes a small implementation of that one function.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "shape",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Rotational flattening",
    "d": "Saturn is visibly squashed — about 10% flattening. Haumea spins in under four hours and is a triaxial ellipsoid roughly twice as long as it is thick. Derive flattening from rotation rate, density and gravity through `radiusAt`, and the gas giants stop looking like beach balls.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "oblate",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Roche-lobe distortion — the egg-shaped planet",
    "d": "WASP-12 b fills its Roche lobe and is measurably prolate, losing mass to its star through the inner Lagrange point while its orbit decays by tens of milliseconds per year. Nothing sells \"this is a different regime\" faster than a planet that is not round.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "roche",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Tidal bulges on locked moons",
    "d": "A synchronously locked moon is a triaxial ellipsoid with its long axis pointed at the parent. Mimas and Io both show it. Combined with libration this produces real, visible flexing — which is also the geometry that generates the tidal heat.",
    "e": "S",
    "i": 2,
    "b": "",
    "s": "triaxial",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Bodies too small to be round",
    "d": "Below roughly 400 km, self-gravity loses to material strength: Phobos is a 27 × 22 × 18 km potato, Hyperion is a sponge, Arrokoth is two lobes stuck together. Feed a low-order spherical-harmonic or signed-distance shape into `radiusAt` and the small-body shelf opens up.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "irregular",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Rings as geometry and as shadow",
    "d": "Rings need three things: a rendered annulus, a shadow band cast on the planet that migrates with season, and — for Saturn at 26.7° obliquity — an edge-on presentation twice per orbit. The shadow is what makes them feel physical rather than pasted on.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "rings",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Satellites in the sky",
    "d": "Give a world a satellite list with real orbital elements, render them, and let them raise tides. Once this exists, the moons shelf can be entered from either side: stand on Europa and see Jupiter, or stand on Jupiter and watch four dots.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "moons",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Eclipses, and their thermal signature",
    "d": "Io passes into Jupiter's shadow every 42 hours and its thin SO₂ atmosphere freezes onto the ground each time, then sublimates again — measured directly in 2023. An eclipse is not a lighting effect here; it is a chemistry event.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "eclipse",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "The parent planet filling the sky",
    "d": "From Europa, Jupiter is about 12° across — twenty-four full Moons — and never moves from its spot in the sky, because Europa is locked. It lights the night side, it eclipses the Sun, and it is the reason the local view exists.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "parent",
  ...
  },
  {
    ...
    "c": "spin",
    "k": "PHYS",
    "t": "Orbital decay and migration during the run",
    "d": "TOI-2109 b and WASP-12 b are both spiralling in on measurable timescales; Phobos will hit Mars or shatter into a ring within about 50 Myr. Let semi-major axis be a state variable rather than a constant, and long runs acquire an ending.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "migrate",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Extend the gas vector past six species",
    "d": "The current mixture is N₂/O₂/CO₂/CH₄/H₂O/dust/sulphate. The catalogue needs H₂, He, NH₃, SO₂, CO, and rock vapour. Make the mixture a keyed map with per-species molar mass, condensation curve and opacity, rather than seven named fields.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "gassuite",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Surface pressure and scale height from first principles",
    "d": "`totalPressure()` sums mixing ratios, which is dimensionally meaningless. Compute column mass, then pressure from gravity, then scale height from mean molecular weight and temperature. Venus at 92 bar and Mars at 6 mbar should be the same code with different inputs.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "hydrostatic",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "A real phase diagram per volatile",
    "d": "`liquidWaterOk` is a boolean. Replace it with a triple-point-aware check per species, so CO₂ can snow on Mars, N₂ can glaciate on Pluto, methane can rain on Titan, and water can be supercritical on a hot sub-Neptune — all through one function.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "phase",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Magma oceans",
    "d": "Above roughly 1,500 K the surface is liquid rock. It convects, it has an albedo near 0.1, it quenches into a glassy crust on any night side, and it exchanges volatiles with the atmosphere far faster than solid rock does. This is the substrate for the entire furnace shelf.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "magma",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Rock vapour atmospheres",
    "d": "On K2-141 b (T_eq 2,103 K) the atmosphere is vaporised sodium, SiO and SiO₂, it extends only over the day side, winds reach supersonic speeds, and it rains molten rock back into the magma ocean. A closed mineral cycle with the same structure as Earth's water cycle.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "rockvapour",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Mineral clouds",
    "d": "Silicate and corundum clouds on brown dwarfs, quartz nanocrystals confirmed by JWST on WASP-17 b, and the glass rain of HD 189733 b. Reuse the existing cloud field but let the condensate species be chosen by temperature so clouds carry information about depth.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "minclouds",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Iron condensation and nightside iron rain",
    "d": "On WASP-76 b iron is vapour on the day side at roughly 2,400 K and condenses as it crosses the terminator, so it rains iron on the night side. One extra condensable in the existing precipitation code produces the most famous image in exoplanet science.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "ironrain",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Hydrodynamic escape and the radius valley",
    "d": "The current escape rule is a linear leak on low gravity. Replace it with an energy-limited hydrodynamic model driven by XUV flux, which reproduces the observed scarcity of planets between 1.5 and 2.0 R⊕ as an emergent result rather than a fact stated in a tooltip.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "escape",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Escaping atmospheres with visible tails",
    "d": "GJ 436 b trails a hydrogen cloud far larger than its star; GJ 3470 b has a helium tail; HD 209458 b was the first world caught evaporating. Render the tail. It is the only case in the catalogue where the atmosphere is visible from outside the planet.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "tail",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Disintegrating planets",
    "d": "Kepler-1520 b and K2-22 b produce comet-like dust tails whose transit depth varies from one orbit to the next, because the planet is actively boiling away. The body loses mass on-screen, and the run has a hard, dated end.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "disintegrate",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Stripped cores",
    "d": "TOI-849 b has 41.8 M⊕ packed into 3.6 R⊕ — the naked core of a giant that lost its envelope, sitting in the hot-Neptune desert. Model the envelope as a removable layer so the same body can be run before and after.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "chthonian",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Primordial H₂/He envelopes and the end of the heightfield",
    "d": "Most of the catalogue by mass has no surface. Introduce a pressure-level substrate — the sim runs on an isobar instead of a ground layer — so the existing cube-sphere machinery still works with `h` reinterpreted as depth into the envelope.",
    "e": "L",
    "i": 3,
    "b": "",
    "s": "h2",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Banded circulation for giants",
    "d": "The three-cell model in `computeWinds` becomes many-celled on a fast rotator with no surface drag: Jupiter has around a dozen alternating jets, Neptune has 500 m/s equatorial winds. Make the cell count a function of the Rhines scale rather than a constant.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "bands",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Long-lived vortices",
    "d": "The Great Red Spot has persisted for centuries; Neptune's dark spots come and go in years. Track vortices as objects that merge, shear and drift in latitude, which is also the only way a gas giant reads as alive from orbit.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "vortex",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Super-puffs",
    "d": "Kepler-51 b is 7.1 R⊕ and 2.1 M⊕ — a density around 0.03 g/cm³, less than cotton candy. Whether they are genuinely enormous or are ordinary planets with high hazes is unsettled; both readings should be reachable from the same simulation state.",
    "e": "S",
    "i": 2,
    "b": "",
    "s": "superpuff",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Hycean worlds",
    "d": "A deep liquid-water ocean under a thick H₂ envelope, with surface pressures and temperatures that could be habitable well outside the classical zone. K2-18 b is the test case. Build it as a genuine regime with a real ocean, not a recoloured Terra.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "hycean",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Deep water worlds and high-pressure ice",
    "d": "Past roughly 100 km of ocean, the floor is ice VI and VII rather than rock, which cuts off the silicate weathering thermostat that stabilises Earth's climate. A water world is not a wetter Earth; it is a world with the carbon cycle disconnected.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "waterworld",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Ice shells over subsurface oceans",
    "d": "A rigid conducting lid over a convecting liquid layer, with thickness set by the balance of tidal heat below and radiative loss above — 15–25 km on Europa, thinner at Enceladus's south pole. This is the most-requested habitat in planetary science and the engine has no concept of it.",
    "e": "L",
    "i": 3,
    "b": "",
    "s": "iceshell",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Cryovolcanism",
    "d": "Enceladus vents water vapour, salt and silica grains through the tiger stripes at its south pole, supplying Saturn's E ring. Reuse the volcano entity wholesale — same magma budget, same eruption schedule, different working fluid.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "cryo",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Nitrogen and methane glaciers",
    "d": "Sputnik Planitia on Pluto is a convecting nitrogen ice sheet with cells tens of kilometres across, resurfacing itself on a timescale of centuries. The existing glacier mass-balance code should take the condensable species as a parameter.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "n2glacier",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "A methane hydrological cycle",
    "d": "Titan has rivers, lakes, seas, rain and a seasonal cycle — all in methane and ethane, at 94 K, under 1.5 bar of nitrogen. The hydro module should be able to run on a different liquid without any of it being special-cased.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "methanecycle",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Photochemical haze and tholins",
    "d": "Titan's orange comes from tholins produced when UV breaks up methane and nitrogen. The same process flattens the transmission spectra of sub-Neptunes like GJ 1214 b. Haze is an optical layer, a chemical sink and a plot device about what instruments cannot see.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "haze",
  ...
  },
  {
    ...
    "k": "PHYS",
    "t": "Sulfur chemistry",
    "d": "Venus has a global sulfuric acid cloud deck that rains and evaporates before reaching the ground; Io is coated in SO₂ frost and sulfur allotropes that make it yellow. `sulphate` currently exists only as a volcanic-winter decay term.",
    "e": "M",
    "i": 2,
    "b": "",
    "s": "sulfur",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Carbon-rich worlds",
    "d": "In a system with C/O above about 0.8 the mantle mineralogy is carbides and graphite instead of silicates, with diamond at depth. 55 Cnc e was the poster child before the ratio was revised downward — which is itself worth teaching.",
    "e": "M",
    "i": 1,
    "b": "",
    "s": "carbon",
  ...
  },
  {
    ...
    "c": "matter",
    "k": "PHYS",
    "t": "Internal heat as the whole energy budget",
    "d": "For a rogue planet, radiogenic decay plus leftover formation heat is all there is. A thick enough hydrogen envelope can still hold liquid water underneath it. Track internal heat as a decaying reservoir, and this becomes the one number that keeps a starless world alive.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "radiogenic",
  ...
  },
  {
    ...
    "c": "arch",
    "k": "PHYS",
    "t": "Youth as a state: hot, inflated, still accreting",
    "d": "A world 10 Myr old is glowing from its own formation heat, is physically larger than its final size, sits inside a disc, and is being hit constantly. Make age a real parameter that drives internal heat, radius and impact rate rather than a label.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "young",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "A system browser you hold, not a menu you scroll",
    "d": "The current UI is five buttons and number keys 1–5. Ninety-plus worlds needs a physical shelf: an orrery of systems you reach into, pull a planet out of, and drop into your hands. This is the interaction the product is named after and it does not exist yet.",
    "e": "L",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "The transit spectrum instrument",
    "d": "Point an instrument at your own world and get back the spectrum an observer 40 light years away would actually measure — noisy, low-resolution, and degenerate. Then let the player compare it to the real JWST spectrum of that planet. This is the single best teaching device available to us.",
    "e": "L",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "The phase curve instrument",
    "d": "Watch the brightness of your world over an orbit and read the hotspot offset, the day-night contrast and the cloud asymmetry off the curve — the same way HD 189733 b and Kepler-7 b were characterised. It turns invisible circulation into a line you can watch bend.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "The habitable zone as a place you stand in",
    "d": "Render the conservative and optimistic zone boundaries as a physical band in the orrery that moves as the star evolves and sweeps outward at the end of the main sequence. Habitability stops being a label and becomes a location.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "Hold two worlds at once",
    "d": "Side-by-side comparison at true relative scale, with the same instruments applied to both. Callisto next to Europa, TRAPPIST-1 b next to e, Venus next to Earth — every important point in this document is a comparison, not a single object.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "\"Why is it like this\" — a causal readout",
    "d": "Tap any state and get the chain that produced it: this ice sheet exists because insolation is 0.37 Earth and the CO₂ column is thin because the star stripped it in the first 300 Myr. The engine already computes every link; it just never shows the chain.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "Make uncertainty visible",
    "d": "Half these worlds have no measured mass, or a radius with 20% error, or a contested atmosphere. Render unknowns as visible fog or flicker rather than picking a number silently. A catalogue that hides its error bars is teaching the wrong lesson.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "instr",
    "k": "UX",
    "t": "The sky as the instrument",
    "d": "Stand on the surface in the local view and look up: star colour and angular size, the parent planet, the other moons, the rings edge-on, two shadows, an aurora. Everything in the spin and star categories should be verifiable by looking, not by reading a panel.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "pipe",
    "k": "UX",
    "t": "Import from the NASA Exoplanet Archive",
    "d": "A build-time script hitting the TAP service at `exoplanetarchive.ipac.caltech.edu/TAP/sync` against the `pscomppars` table, pulling radius, mass, period, semi-major axis, eccentricity, insolation, equilibrium temperature and host parameters. Hand-authoring 150 ruleset literals is not a plan.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "pipe",
    "k": "UX",
    "t": "Derive ruleset parameters from catalogue columns",
    "d": "A pure function from archive row to ruleset: gravity from mass and radius, freeze point from composition, locking from period and distance, relief from gravity, plate count from radius. Then the hand-authored part of each world is only its character, not its physics.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "pipe",
    "k": "UX",
    "t": "Provenance and citation on every world",
    "d": "Each entry carries its source, the reference date, and a link. When the archive updates a mass, the world changes and the chronicle records that it changed. This is what separates a science toy from a science instrument.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "pipe",
    "k": "UX",
    "t": "Pin a snapshot, and be honest about nulls",
    "d": "The archive is a moving target — Barnard's Star gained four planets in two years and tau Ceti's list has been revised repeatedly. Commit a dated snapshot so builds are reproducible, and give every missing value an explicit \"unknown\" path rather than a silent default.",
    "e": "S",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "play",
    "k": "UX",
    "t": "An archetype ladder rather than a flat list",
    "d": "Ninety worlds presented at once is a spreadsheet. Order them so each new world introduces exactly one new mechanic — Earth, then Mars, then the Moon, then Venus, then Europa, then TRAPPIST-1 e — and the catalogue teaches itself in the order the physics was built.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "play",
    "k": "UX",
    "t": "A scenario per world, in one sentence",
    "d": "\"Keep TRAPPIST-1 e's atmosphere through a thousand flares.\" \"Stop Venus before 92 bar.\" \"Find the terminator band where anything can live.\" Each world in this document has one obvious question attached to it; write it down and make it a win condition.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "play",
    "k": "UX",
    "t": "A chronicle voice per regime",
    "d": "The chronicle currently narrates a temperate Earth. A magma world needs a different vocabulary, a rogue planet needs a colder one, and a pulsar planet's history is measured in the star's pulses. Cheap, and it is most of what the player takes away.",
    "e": "S",
    "i": 2,
    "b": "",
    "s": "",
  ...
  },
  {
    ...
    "c": "play",
    "k": "UX",
    "t": "The scale moment in VR",
    "d": "Hold TRAPPIST-1 in two hands at once — all seven planets fit inside Mercury's orbit, so the whole system is a grapefruit. Then shrink to stand on e and look up at a star four times the width of the Sun. That single transition is the argument for the headset.",
    "e": "M",
    "i": 3,
    "b": "",
    "s": "",
